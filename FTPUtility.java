...
public class FTPUtility {
    ...
    public long getFileSize(String filePath) throws FTPException {
        try {
           ...
           // ftpClient.cwd("C:/Users/Administrator/Desktop/");
     ...
     *             if client-server communication error occurred
     */
    public void uploadFile(String uploadPath) throws FTPException {
        try {
            ...
            inputStream = ftpClient.retrieveFileStream(uploadPath);
           // outputStream = ftpClient.
 
            if (inputStream == null) {
                throw new FTPException(
                        "Could not open input stream. The file may not exist on your computer.");
            }
        } catch (IOException ex) {
